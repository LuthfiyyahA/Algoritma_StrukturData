<div align="center">
<h1> Laporan Praktikum Pertemuan 15</h1>
...
* ### Kode Program 4
    ...
    ```
* ### Output Kode
    <img src = "./gambar/Percobaan 1(1).png">
    <img src = "./gambar/Percobaan 1(2).png">
* ### Pertanyaan
...
* ### Jawaban
    1. 
    2. Tujuan dari pembuatan variabel tersebut adalah untuk menyimpan edge dari graph yang menggunakan Double Linked List
    3. Pada methode removeEdge akan menerima input gedung asal dan gedung tujuan yang akan dihapus. Kemudian input akan disesuaikan dengan data yang ada, jika input tersebut ditemukan maka akan dihapus dari list yang tersimpan pada list[]. Apabila input yang akan dihapus merupakan node pertama(head), maka head akan diubah ke node selanjutnya.
    4. Pemanggilan method addFirst() dilakukan karena pada struktur data Double Linked List digunakan untuk menambahkan elemen baru di awal list, dibandingkan dengan methode add() methode ini lebih membantu dalam mempercepat proses penambahan edge pada graf, terutama jika penambahan edge sering dilakukan pada awal list edge.
    5. <img src = "./gambar/P1 No5.png">
## 2. Percobaan 2: 
* ### Kode Program 1
    ```java
...
* ### Jawaban
    1. 
    2. Pada Percobaan 2 menggunakan adjacency matrix, yang menerapkan array 2D dengan size V x V dimana V adalah jumlah node pada graph.
    3. Dua baris kode tersebut digunakan untuk menambahkan edge antara gedung asal 1 dan gedung tujuan 2 dengan jarak 70 serta antara gedung asal 2 dan gedung tujuan 1 dengan jarak 80.
    4. <img src = "./gambar/P2 No4.png">
## 4. Latihan Praktikum
* ## Tugas
    ...
    * ### Modifikasi Percobaan 2
        ...
        * ### Kode Program 2
            ...
            ```
    * ### Output Kode
        1. <img src = "./gambar/T1.png">
        2. <img src = "./gambar/T2.png">
        3. <img src = "./gambar/T3 P1.png">, <img src = "./gambar/T3 P2.png">